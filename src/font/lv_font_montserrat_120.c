 ...
 * Size: 120 px
 * Bpp: 4
 * Opts: --bpp 4 --size 120 --no-compress --stride 1 --align 1 --font Montserrat-Bold.ttf --symbols 1234567890 --format lvgl -o lv_font_montserrat_120.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3212, .adv_w = 753, .box_w = 38, .box_h = 85, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4827, .adv_w = 1133, .box_w = 68, .box_h = 86, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7751, .adv_w = 1137, .box_w = 68, .box_h = 86, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 10675, .adv_w = 1323, .box_w = 79, .box_h = 85, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 14033, .adv_w = 1142, .box_w = 68, .box_h = 86, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 16957, .adv_w = 1223, .box_w = 71, .box_h = 88, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 20081, .adv_w = 1190, .box_w = 68, .box_h = 85, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 22971, .adv_w = 1267, .box_w = 71, .box_h = 88, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 26095, .adv_w = 1223, .box_w = 70, .box_h = 88, .ofs_x = 2, .ofs_y = -1}
};
