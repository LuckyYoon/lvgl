 ...
 * Size: 120 px
 * Bpp: 4
 * Opts: --bpp 4 --size 120 --no-compress --stride 1 --align 1 --font Montserrat-Regular.ttf --symbols 1234567890 --format lvgl -o lv_font_montserrat_120.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1271, .box_w = 68, .box_h = 87, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 2958, .adv_w = 693, .box_w = 29, .box_h = 85, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4191, .adv_w = 1091, .box_w = 62, .box_h = 86, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 6857, .adv_w = 1083, .box_w = 61, .box_h = 86, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 9480, .adv_w = 1269, .box_w = 74, .box_h = 85, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 12625, .adv_w = 1087, .box_w = 62, .box_h = 86, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 15291, .adv_w = 1169, .box_w = 64, .box_h = 87, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 18075, .adv_w = 1131, .box_w = 63, .box_h = 85, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 20753, .adv_w = 1225, .box_w = 66, .box_h = 87, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 23624, .adv_w = 1169, .box_w = 64, .box_h = 87, .ofs_x = 3, .ofs_y = -1}
};
